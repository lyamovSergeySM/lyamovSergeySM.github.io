var gulp       = require('gulp'), // Подключаем Gulp
	...
	concatCss    = require('gulp-concat-css'), //собарть css в кучу
...
gulp.task('scripts', function() {
	return gulp.src([ // Берем все необходимые библиотеки
		'app/libs/jquery-3.4.1.min.js', // Берем jQuery
		'app/libs/bootstrap-4.0.0-dist/js/bootstrap.bundle.js', // Берем bootstrap
		'app/libs/bootstrap-4.0.0-dist/js/bootstrap.js', // Берем bootstrap
...
gulp.task('css-libs', function() {
	return gulp.src([
			'app/libs/bootstrap-4.0.0-dist/css/bootstrap-grid.css',
			'app/libs/bootstrap-4.0.0-dist/css/bootstrap-reboot.css',
			'app/libs/bootstrap-4.0.0-dist/css/bootstrap.css'])
